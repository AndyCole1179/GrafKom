...
class garis:
    ...
    def gbcgaris(self):#cermin = garis
        ...
        if self.benda.kooratas[1] > display[1]/2:
            benda = benda+1
        else:
            benda = benda-1
        self.KoorCerminAtas = (self.cermin.Center[0]+r,benda)
        if self.benda.kooratas[0] >display[0]/2:
            DrawC.dda((display[0],benda),self.KoorCerminAtas,self.warna)
        else:
    ...
    def gicgaris(self): # Cermin = garis
        ...
        if self.bayangan.cooratas[0] > display[0]/2:
            DrawC.ddadot((display[0],self.bayangan.cooratas[1]),self.KoorCerminBawah,self.warna)
        else :
    ...
    def kalkulasi(self,coor1,coor2):
        ...
        x2,y2 = coor2
        if x1 == x2:
            return (x1, 0), (x1, display[1])
    
        if y1 == y2:
            return (0, y1), (display[0], y2)
    ...
    def gif(self):
        ...
        if self.benda.koor[0] > self.cermin.focus[0]  and self.benda.koor[0]< self.cermin.perimeter[0]:
            ...
            if self.bayangan.cooratas[1] <display[1]/2:
                if bebek[0][0] == 0:
